...
var $error : Object
var $builder : cs:C1710.Build

$appleUserID:="roland"+Char:C90(64)+"lannuzel.net"  // I don't like my email on github in clear text
$bundleID:="com.4d.rl.generator"

var $builder : cs:C1710.Build

$builder:=cs:C1710.Build.new()
...
If ($error.success=True:C214)
	...
	$message:=Request:C163("Commit message"; Timestamp:C1445)
